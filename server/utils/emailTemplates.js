    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 20px; background-color: #0B0F17; color: #F3F4F6;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #1F2937; border-radius: 10px; padding: 30px; border: 1px solid #374151;">
          <img src="https://despy.ai/logo.png" alt="DeSpy AI Logo" style="display: block; margin: 0 auto 30px; width: 120px;">
          ...
          <p style="color: #9CA3AF; text-align: center; font-size: 12px;">
            ...
            To unsubscribe, <a href="https://despy.ai/unsubscribe?email=${email}" style="color: #60A5FA;">click here</a>
          </p>
        </div>
      </body>
    </html>
...
export const updateEmailTemplate = (email, updateTitle, updateContent) => ({
  subject: `DeSpy AI Update: ${updateTitle} 🔥`,
  html: `
    <!DOCTYPE html>
    <html>
      <head>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 20px; background-color: #0B0F17; color: #F3F4F6;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #1F2937; border-radius: 10px; padding: 30px; border: 1px solid #374151;">
          ...
          <h1 style="color: #3B82F6; text-align: center; margin-bottom: 30px;">${updateTitle}</h1>
